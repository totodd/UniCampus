...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GPSIndoorLocationProvider/GPSIndoorLocationProvider.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SelectorIndoorLocationProvider/SelectorIndoorLocationProvider.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Socket.IO-Client-Swift/SocketIO.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SocketIndoorLocationProviderObjc/SocketIndoorLocationProviderObjc.framework"
